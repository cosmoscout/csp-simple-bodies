...
uniform vec3 uSunDirection;
layout(binding = 0) uniform sampler2D uSurfaceTexture;
...
bool SimpleBody::Do() {
  ...
  mShadowReceiver.setupRender(*mShader, cs::core::EclipseCalcType::CARTESIAN_TEXTURE_LOOKUP, 1);
  ...
  mShadowReceiver.cleanUpRender(cs::core::EclipseCalcType::CARTESIAN_TEXTURE_LOOKUP, 1);
